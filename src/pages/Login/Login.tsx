...
export default function Login() {
  ...
  const { user } = useSelector((state: RootState) => state?.reducer?.AuthSlice);
  ...
  const onSubmit = async (datainfo: { email: string; password: string }) => {
    try {
      ...
      if ((maindata as any)?.error) {
        console.error("up herer", (maindata as any).error);
      } else {
